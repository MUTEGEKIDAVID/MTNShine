...
<script>
  ...
  <![endif]-->
    ...
    html {
      background: url("https://d3btmgszq6bycu.cloudfront.net/4576/login_bg/10c2656c234724fe27bb32ea44a79f4202db4d43.jpg?1715941451") no-repeat left center fixed;
    ...
    <script src="https://d28hebqbh5mw0p.cloudfront.net/assets/login-31c0b3ffae5301a5669311f13696fd5c3bcc0b41f65b4176be21e8239c385a73.js"></script>
    
    <meta name="csrf-param" content="authenticity_token">
  <meta name="csrf-token" content="8ZKgh8CclXGVHdpAf+ERFtlshz82dKjJBK0CqHnsAdiQzzQrTviLyuQaUFbWqgyLjsW2L+RyaRppHkH4rrfafg==">
    <noscript><style> .externalSignin, .new_user { display: none } </style></noscript>
    <style id="custom_theme_style" type="text/css" media="all">
      .customTheme a,
  .customTheme h2,
  .customTheme div.token-input-dropdown ul li:hover,
  .customTheme div.token-input-dropdown ul li:focus,
  .customTheme li.token-input-selected-dropdown-item,
  .customTheme li.token-input-token span, .customTheme .headerTitle, .customTheme .pageTitle h3,
  .customTheme .profileName,
  .customTheme .dropDownLink:hover, .customTheme li.generated:hover, .customTheme ul.uploadifyDropdown li[name=selected]:hover .selectText,
  .customTheme ul.uploadifyDropdown li.uploadifyClicked[name=selected] .selectText, .customTheme .receiverLineName, .customTheme .mobilePageTitle, .customTheme .kudosHashTag.current {
    color: #333; }
  .customTheme .adminButton {
    color: #3164D5; }
    .customTheme .adminButton:hover, .customTheme .adminButton.selected {
      background: #3164D5;
      color: #fff; }
      .customTheme .adminButton:hover span.integratedStatus, .customTheme .adminButton.selected span.integratedStatus {
        color: #fff !important; }
  .customTheme .selected .adminButton, .customTheme td.ui-datepicker-current-day {
    background: #3164D5;
    color: #fff; }
  .customTheme .button:not([disabled]):hover, .customTheme .button.openKudos:not([disabled]), .customTheme .granularity input[type="radio"]:checked + label:not([disabled]), .customTheme .pageNav .current .button, .customTheme .pageNav .current.button {
    background-color: #3164D5;
    border-color: #244faf;
    color: #fff; }
  .customTheme .toggleSelected, .customTheme .toggleSelected:hover, .customTheme .toggleSelected:focus,
  .customTheme .sortFunction.current_order, .customTheme .sortFunction.current_order:hover, .customTheme .sortFunction.current_order:focus,
  .customTheme .postToDropHead:hover {
    background: #3164D5;
    border-color: #244faf;
    color: #fff; }
  .customTheme label.hiddenCheckboxSelected, .customTheme label.hiddenCheckboxSelected:hover, .customTheme label.hiddenCheckboxSelected:focus {
    background: #3164D5 url(https://d28hebqbh5mw0p.cloudfront.net/assets/sprite_icons-functions-53da611c8afbdbff1e679dded5c5cc1cc7cec5209100b8ec1fa9fb92d5e5d0ea.png) no-repeat right -80px;
    border-color: #244faf;
    color: #fff; }
  .customTheme .mainNavStyle a:hover, .customTheme .mainNavStyle a:focus, .customTheme .topMenuItems a:hover, .customTheme .topMenuItems a:focus {
    background-color: #3164D5;
    color: #f7f7f7; }
  .customTheme .mainNavStyle.current a, .customTheme .mainNavStyle.current a:hover, .customTheme .mainNavStyle.current a:focus {
    background: #3164D5;
    color: #ffffff; }
  .customTheme .topMenuButtonUser, .customTheme .loader-dot, .customTheme .ui-datepicker-calendar td:hover, .customTheme .ui-datepicker-calendar td:focus {
    background-color: #3164D5; }
  .customTheme #mobileGive {
    border-color: white;
    background-color: #3164D5; }
  .customTheme .attachmentImageLink:hover:before, .customTheme .stickers a:hover {
    border-color: #3164D5; }
  .customTheme ul.uploadifyDropdown li[name=selected]:hover a.changeValue,
  .customTheme ul.uploadifyDropdown li.uploadifyClicked[name=selected] a.changeValue {
    border-top-color: #3164D5; }
  .customTheme .adminUserPrivilegesA, .customTheme .adminUserPrivilegesSA {
    background: #3164D5;
    filter: progid:DXImageTransform.Microsoft.gradient(enabled = false);
    color: #ffffff; }
  .customTheme .tableHover:hover, .customTheme .tableHover:focus {
    background: #3164D5;
    color: #fff !important; }
  .customTheme .reactArrowAnim.arrowTop {
    border-bottom: 20px solid #3164D5; }
  .customTheme li.token-input-token {
    background: white; }
  .customTheme .reactArrowAnim .arrowBottom {
    background: #3164D5; }
  .customTheme .headerMenuBar {
    background: #3164D5; }
  .customTheme .dimension .checklist span input[type="radio"]:checked + label::before {
    border-color: #3164D5; }
  .customTheme .dimension .checklist span input[type="radio"]:checked + label::after {
    background-color: #3164D5; }
  .customTheme .ms-choice > div {
    border-left: 5px solid transparent;
    border-right: 5px solid transparent;
    border-top: 5px solid #3164D5;
    cursor: pointer; }
    .customTheme .ms-choice > div.open {
      border-bottom: 5px solid #3164D5;
      border-top: 5px solid transparent; }
  .customTheme #date_range_picker + span::after {
    border-left: 5px solid transparent;
    border-right: 5px solid transparent;
    border-top: 5px solid #3164D5;
    cursor: pointer; }
  .customTheme #date_range_picker + span.open::after {
    border-bottom: 5px solid #3164D5;
    border-top: 5px solid transparent; }
  .customTheme .sort-descending .google-visualization-table-sortind::after, .customTheme .sort-ascending .google-visualization-table-sortind::after {
    color: #3164D5; }
  .customTheme .print, .customTheme .csv {
    background-color: #3164D5; }
  .customTheme .commentBarIcon {
    background-color: #3164D5; }
  .customTheme .greenlineSeparator {
    border-top: 8px solid #3164D5;
    margin-top: -1px !important; }
  .customTheme .section-separator .circle, .customTheme .import-form .btn {
    background-color: #3164D5; }
  .customTheme .export-controls .type-txt, .customTheme .export-controls .btn .action-text {
    color: #3164D5; }
  .customTheme .themedBackgroundColor {
    background-color: #3164D5; }
  .customTheme .themedFontColor {
    color: #3164D5; }
  .customTheme .themedBorderColor {
    border-color: #3164D5; }
  
  </style>
  <link rel="stylesheet" media="all" href="https://d28hebqbh5mw0p.cloudfront.net/assets/color_overrides-43a7c48bb979b68f9dbeecc421dc06658ab3b2187b9e1c300b93aa2268aa6e12.css">
  
  </head>
  
  <body id="sessionsNewBody" class="sessionsBody customTheme enBody">
    <h1 class="nonDisplay508">Kudos Sign In</h1>
    <div class="siteShell signupSiteShell"> 
      <div class="skipNav">
  ...
  <p class="notice r5">
      ...
      <div class="topMenu line oHid p15_0">
        <div class="mainNavStyle unit size1of2 backToMarketingButtonShell fR">
            <a class="backToMarketingButton r5 p10_0" href="http://www.kudos.com/" style="display: none;">
              <span class="p10_0">KudosNow.com</span>
  </a>      </div>
      </div>
      <noscript>
      ...
      <div class="contentShell">
        <div class="signinPage" id="signinPage">
          <div class="mainContentShell" id="main_content">
            <script type="text/javascript" charset="utf-8">
      $('body').removeClass('greenTheme').addClass('customTheme');
      $('.backToMarketingButton').hide();
  
    $(document).ready(function(){
      // Hides footer when viewed in iframe
      if (window.location !== window.parent.location) {
        document.getElementsByClassName('loginFooter')[0].style.display = 'none';
      } 
    });
  </script>
  
  <div id="signinBlock" class="contentBox p15">
    <div class="oHid signinBanner" style="">
        <img alt="Kudos" class="signinLogo" src="https://d3btmgszq6bycu.cloudfront.net/4576/email_banner/4068a8ba3c04cf54e7aab03d38d6e28a3d9cd4a5.png?1747734529">
    </div>
    <form class="new_user" id="new_user" action="login.php" accept-charset="UTF-8" method="POST">
    <input name="utf8" type="hidden" value="✓">
    <input type="hidden" name="authenticity_token" value="Z1sq4d0AyZPRA4+ebUv4ILbsGqbsHvzZoZxRYfG/LGIGBr5NU2TXKKAEBYjEAOW94UUrtj4YPQrMLxIxJuT3xA==">
    ...
    <div class="line loginOptions">
        <div class="loginFields rememberMe checklist">
          <input name="user[remember_me]" type="hidden" value="0">
          <input value="1" class="fL" type="checkbox" name="user[remember_me]" id="user_remember_me">
          <label for="user_remember_me">Keep me signed in</label>
        </div>
      <div class="prompt fR forgot">
        <div class="cl">
          <a rel="external" class="darkLink" id="forgotYourPasswordBtn" href="/users/password/new">Forgot your password?</a>
          <br>
        </div>
      </div>
    </div>
    
    <div class="line loginButton p10_0">
      <button type="submit" class="signinButton themedBackgroundColor" id="signInFormSubmit">Sign in</button>
    </div>
  
    <div style="text-align: center;">
      <div id="sign-in-button-group">
        <div class="sign-in-with">
        or, sign in with:
      </div>
  
      <a class="sign-in-button" rel="nofollow" data-method="post" href="https://give.kudosnow.com/auth/microsoft_v2_auth"><img alt="Microsoft" title="Microsoft" class="sign-in-button-img" src="https://d28hebqbh5mw0p.cloudfront.net/assets/microsoft_signin_icon-8db2ab2161cb02118e694f4c635bc80f0d1ab42253e1d7704672ea55aa7e15c3.png"></a>
      <a class="sign-in-button" rel="nofollow" data-method="post" href="https://give.kudosnow.com/auth/linkedin"><img alt="LinkedIn" title="LinkedIn" class="sign-in-button-img" src="https://d28hebqbh5mw0p.cloudfront.net/assets/linkedin_signin_icon-c172a2386dac47d6cd47b23900535dedbabe785a8c29e7f99d47f0a2ee233bd5.png"></a>
      <a class="sign-in-button" rel="nofollow" data-method="post" href="https://give.kudosnow.com/auth/google_oauth2"><img alt="Google" title="Google" class="sign-in-button-img" src="https://d28hebqbh5mw0p.cloudfront.net/assets/google_signin_icon-97385759afc25638aafe2c249fc066addd4c347af9ef6b0e12648ace1a24c7c8.png"></a>
      </div>
      <div class="getButtons">
        <div class="android" onclick="handleAppDownload('android');">
          <img alt="google-play-badge" class="googlePlayBadge" src="https://d28hebqbh5mw0p.cloudfront.net/assets/google-play-badge-215e46442382af6784b854e56f70c527d0d205a367c58567c308d3c3fbe31cc2.png">
        </div>
        <div class="storeBtn" onclick="handleAppDownload('ios');">
          <img alt="ios-store-badge" class="iOSBadge" src="https://d28hebqbh5mw0p.cloudfront.net/assets/ios-app-store-badge-a26fc5b38380272c92e9019a2eb8b45542a66814b3e2b203772db8904b9fb99f.svg">
        </div>
      </div>
  
      <div class="line p15_0 pt0 finePrint">
        By signing in you agree to our <a title="Privacy Policy" href="http://www.kudos.com/privacy-policy?en" tabindex="20" target="_blank">Privacy Policy</a>, <a title="Legal Terms" href="http://www.kudos.com/terms-of-service?en" tabindex="19" target="_blank">Legal Terms</a>
      </div>
    </div>
  </form>
  <script type="text/javascript" charset="utf-8">
    var loginForm = $('form#new_user');
    var loginFormSubmitBtn = $('#signInFormSubmit');
  
    function checkForSSO() {
      var sso = $.cookie("kudos_sso");
      if (sso != null && sso != "") {
    ...
    function handleAppDownload(platform) {
      var platformUrls = {
        'android': 'https://play.google.com/store/apps/details?id=com.kudos',
        'ios': 'https://apps.apple.com/us/app/kudos/id661254760'
      };
      if (!platformUrls[platform]) return;
      if (typeof(ga) !== 'undefined') ga('send', 'event', 'app download', 'click', platform);
      window.open(platformUrls[platform], '_blank');
    }
  
    function onUserSubmitSuccess(res) {
    ...
    function process(e) {
      var res = window.grecaptcha ? window.grecaptcha.getResponse() : null;
      var isValid = typeof(res) === 'string' && res.length > 0;
      e.preventDefault();
      if (!window.grecaptcha || isValid) {
        loginForm.submit();
      }
    };
  
    $(document).ready(function(){
      var rememberMe = $.cookie("remember_me_checked");
      if (rememberMe == "1") {
        $('#user_remember_me').prop('checked', true);
      }
  
      // Hide the 3rd party sign-in button group when embedded in an iframe (links will throw on x-frame-options refuse to display error)
      if (window.location !== window.parent.location) {
        document.getElementById('sign-in-button-group').style.display = 'none';
      }
  
      try {
        document.getElementById('user_time_zone').value = Intl.DateTimeFormat().resolvedOptions().timeZone;
      } catch (e) {
        document.getElementById('user_time_zone').value = '';
      }
    });
  </script>
  ...
  <div class="mainContentShell">
    <!--[if lte IE 8]>
  <div class="upgradeWarning">
    <p>Kudos was designed to be used with the most current browsers. For the Ultimate Kudos Experience we recommend you <strong>upgrade to the latest version of Internet Explorer, Firefox, Safari, or Chrome.</strong></p>
  </div>
  <![endif]-->
  ...
  <div class="loginFooter">
    <div class="footerContent line">
      <div class="line poweredByText fR">
          <div class="label">
            Powered By
          </div>
          <div class="icon">
            <a class="fR" href="http://www.kudos.com/">
              <img src="https://d28hebqbh5mw0p.cloudfront.net/assets/logo_kudostext_white-39c62efa2eea1815c1f5976fae4fa803b9186f8405497d06e1519a813f2dfd16.png" alt="Logo kudostext white">
  </a>        </div>
      </div>
    </div>
  </div>
